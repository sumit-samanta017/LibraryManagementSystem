	...
	<img alt="oops..."
		...
		<div id="insideCommonContent_updateRecord">
			...
			<form:form action="updateBookRecord" modelAttribute="bookRecord">
				...
				<form:input path="bookName" size="30"  class="updateInput inputBookName" />
				<br>
				<br>
				<label class="updateLabel labelBookAuthor">Book Author:-</label>
				<form:input path="bookAuthor" size="30"  class="updateInput inputBookAuthor"/>
				<br>
				<br>
				<label class="updateLabel labelBookCost">Book Cost:-</label>
				<form:input path="bookCost" size="20" type="number" class="updateInput inputBookCost"/>
				<br>
				<br>
				<label class="updateLabel labelBookCount">No. of books:-</label>
				<form:input path="noOfItems" size="20" type="number" class="updateInput inputNoOfItems" />
				<br>
				<br>
